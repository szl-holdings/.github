    ...
    def observe(
        ...
        *,
        ...
        return evaluate_target(
            target(),
            workflow={"id": 100, "state": workflow_state},
            runs=runs,
...
class ApiRouteTests(unittest.TestCase):
    class RecordingApi(GitHubApi):
        ...
        def request(
            ...
            if "/actions/workflows/" in path and path.endswith("autonomic-sre.yml"):
                return {"id": 100, "state": "active"}
            if "/runs?" in path:
    ...
    def test_workflow_routes_are_repository_and_path_bound(self) -> None:
        ...
        self.assertIn(".github%2Fworkflows%2Fautonomic-sre.yml", combined)
