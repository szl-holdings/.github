...
<img src="https://raw.githubusercontent.com/szl-holdings/.github/main/profile/assets/banner-org.png" alt="SZL Holdings — Governed AI you can prove. A checkable receipt for every autonomous decision." width="100%" />
...
[![Lambda](https://img.shields.io/badge/%CE%9B-Conjecture%201%20%C2%B7%20Theorem%20U%20conditional-B79BD6?style=flat-square)](https://github.com/szl-holdings/lutar-lean/blob/main/BOUNTY.md)
[![Khipu](https://img.shields.io/badge/Khipu%20BFT-Conjecture%202%20%C2%B7%20Wave23%20conditional-B79BD6?style=flat-square)](https://github.com/szl-holdings/khipu-consensus)
[![SLSA posture](https://img.shields.io/badge/SLSA-L1%20%C2%B7%20L2%20attested%20%C2%B7%20L3%20roadmap-c9b787?style=flat-square)](https://slsa.dev/spec/v1.0/levels)
...
flowchart LR
    ...
    subgraph GOVERNED_RUN_LOOP[GOVERNED RUN-LOOP]
        ...
        P3[P3 · Bounded-Recursion Control<br/>Λ trust gate · Conjecture 1] --> P4
        P4[P4 · Semantic Quorum<br/>KHIPU BFT · Conjecture 2 / Wave23] --> P5
        P5[P5 · Epistemic State Replication] --> P6
    end
    P6[P6 · Signed Receipt<br/>receipt bus · Reed–Solomon · DSSE/cosign] --> R[(Hash-chained<br/>receipt ledger)]
    YACHAY[Read-only reasoning cortex] -. reads .-> P1
    CHAPAQ[Egress inspector] -. inspects .-> P6
